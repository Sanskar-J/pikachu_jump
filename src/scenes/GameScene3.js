...
export default class GameScene3 extends Phaser.Scene{
    ...
    update()
	{
        ...
        // if(this.scoreLabel.score >= 120)
        // {
        //     this.scene.start(AllScenes[3],{score: this.scoreLabel.score})
        // }
    ...
    createPlatforms(){
        ...
        platforms.create(400,568,GROUND_KEY).setScale(2).refreshBody()
            ...
            platforms.create(140,400,GROUND_KEY)
            platforms.create(660,400,GROUND_KEY)
            platforms.create(-50,250,GROUND_KEY)
            platforms.create(850,250,GROUND_KEY)
